...
people_left_bcn <- as.data.frame( people_left %>% filter( attrition=="Yes" & city == "Barcelona") ) 
...
people_left_ldn <- as.data.frame( people_left %>% filter( attrition=="Yes" & city == "London") ) 
