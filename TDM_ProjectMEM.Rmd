...
depts2 %>% tabyl(years_since_last_promotion)
```
We only have two candidates, one of them has been 0 years since his promotion and the other has been 2, therefore the second one should get the next promotion.
