...
The next plot is to show the distribution of job involvement between men and women. It shows that the distribution of job involvement is similar between men and women.

```{r,echo=TRUE,message=FALSE}
job_inv_M <- ggplot(myData%>%filter(gender=="Male"), aes(x=job_involvement,fill="#00BFC4")) + geom_bar() + labs(title = "Job Involvement Men",x="") + guides(fill="none") + scale_fill_manual(values=c("#00BFC4")) + theme_economist()
job_inv_F <- ggplot(myData%>%filter(gender=="Female"), aes(x=job_involvement,fill="#F8766D")) + geom_bar() + labs(title = "Job Involvement Women",x= "") + guides(fill="none") + scale_fill_manual(values="#F8766D") + theme_economist()
...
```{r,echo=TRUE,message=FALSE}
job_lvl_M <- ggplot(myData%>%filter(gender=="Male"), aes(x=job_level,fill='#F8766D')) + geom_bar() + labs(title = "Job Level Men", x="",fill="") + guides(fill="none") + scale_fill_manual(values=c("#00BFC4")) + theme_economist()
job_lvl_F <- ggplot(myData%>%filter(gender=="Female"), aes(x=job_level,fill='#F8766D')) + geom_bar() + labs(title = "Job Level Women", x="") + guides(fill="none") + scale_fill_manual(values=c("#F8766D")) + theme_economist()
...
ggplot(manager_data, aes(x=temp_gender,y=temp_count,fill=temp_gender)) + geom_bar(stat="identity")+labs(title="Number of Managers Betwen Men and Women",x="",y="Count") + theme_economist() + guides(fill="none")
```
...
ggplot(hourly_df, aes(x=temp_gender,y=temp_avg_hourly_rates,fill=temp_gender)) + geom_bar(stat="identity")+labs(title="Average Hourly Wage Between Men and Women",x="",y="Average hourly wage") + theme_economist() + guides(fill="none")
```
...
```{r,echo=TRUE,message=FALSE}
edu_lvl_M <- ggplot(myData%>%filter(gender=="Male")%>%filter(!is.na(gender))%>%filter(education!=""), aes(x=education,fill="")) + geom_bar() + labs(title = "Education level men", x="Education level") + guides(fill="none") + scale_fill_manual(values=c("#00BFC4")) + theme_economist()
edu_lvl_F <- ggplot(myData%>%filter(gender=="Female")%>%filter(!is.na(gender))%>%filter(education!=""), aes(x=education,fill="")) + geom_bar() + labs(title = "Education level women", x="Education level") + guides(fill="none") + scale_fill_manual(values="#F8766D") + theme_economist()
edu_field_M <- ggplot(myData%>%filter(gender=="Male")%>%filter(!is.na(gender))%>%filter(education_field!=""), aes(x=education_field,fill="")) + geom_bar() + labs(title = "Education field men", x="")+coord_flip()  + guides(fill="none") + scale_fill_manual(values=c("#00BFC4")) + theme_economist()
edu_field_F <- ggplot(myData%>%filter(gender=="Male")%>%filter(!is.na(gender))%>%filter(education_field!=""), aes(x=education_field,fill="")) + geom_bar() + labs(title = "Education field men", x="")+coord_flip() + guides(fill="none") + scale_fill_manual(values="#F8766D") + theme_economist()
